...
- **Total: 764 tests passing offline by default** (316 core + 415 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests`)
