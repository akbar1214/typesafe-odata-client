...
- **Total: 846 tests passing offline by default** (366 core + 447 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests` — 970 total incl. live)
