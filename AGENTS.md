...
- **Total: 795 tests passing offline by default** (340 core + 422 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests` — 919 total incl. live)
