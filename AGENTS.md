...
- **Keyed accessor tests (decision 95):** `ContainerGeneratorKeyedOverloadsTest` 4, `RequestGeneratorKeyedNavTest` 6, `RequestGeneratorKeyTest` 3 (composite/inherited keys via overloads, byID-family deletion pinned)
...
- **Total: 765 tests passing offline by default** (317 core + 415 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests`)
