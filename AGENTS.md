...
- **Total: 776 tests passing offline by default** (325 core + 418 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests`)
