...
- **Total: 799 tests passing offline by default** (344 core + 422 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests` — 923 total incl. live)
