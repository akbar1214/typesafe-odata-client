...
- **Total: 784 tests passing offline by default** (329 core + 422 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests` — 908 total incl. live)
