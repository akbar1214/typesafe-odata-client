...
- **Total: 777 tests passing offline by default** (326 core + 418 runtime + 25 maven + 8 test module; the remaining generated-client/live classes run via `-Plive-tests`)
